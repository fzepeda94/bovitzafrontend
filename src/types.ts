...
export interface HealthRecord { id: string; fecha: string; tipo: string; principioActivo: string | null; dosis: number | null; unidad: string | null; via: string | null; proximaAplicacion: string | null; observaciones: string | null }
...
export interface BirthRecord { id: string; fecha: string; estado: 'Borrador' | 'Confirmado' | 'Anulado'; numeroCrias: number; criasVivas: number; criasMuertas: number; criaAnimalId: string | null; sexoCria: Sex | null; tipoParto: string | null; observaciones: string | null }
