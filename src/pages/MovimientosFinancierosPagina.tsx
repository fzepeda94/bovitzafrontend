...
interface DistribucionCostoVista { id:string; ambito:string; beneficiarioId:string|null; metodo:string; montoDistribuir:number; fechaInicio:string|null; fechaFin:string|null; observaciones:string|null; asignaciones:AsignacionCostoVista[] }
